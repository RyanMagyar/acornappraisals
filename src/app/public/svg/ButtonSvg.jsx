const ButtonSvg = (white) => (
  <>
    ...
    >
      <path
        fill={white ? "#b25e7e" : "none"}
        stroke={white ? "#b25e7e" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill={white ? "#b25e7e" : "none"}
        stroke={white ? "#b25e7e" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
